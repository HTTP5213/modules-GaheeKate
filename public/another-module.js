//Use the code from my-script.js to populate these files:
// another-module.js should export theShire, buckland, and HobbitSettlement.
...
let bree = new HobbitSettlement('Bree', 473, 'Atanatári who did not reach Beleriand');
